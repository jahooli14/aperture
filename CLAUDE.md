...
**`stakeSplits` needed the sides to have weight.** The word "or" alone was enough, and one run in five proved it a hole: *"Are you making creative logo t-shirts for friends, or are you just running the same January project twice?"* shipped behind a stake that said "or" and meant nothing by it. A real split has two clauses with their own verbs — *"he writes the last line this week, or admits he wanted the hours"* — so both sides now need four words.
