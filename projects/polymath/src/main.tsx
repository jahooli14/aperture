    ...
    root.innerHTML = `
      <div style="min-height: 100vh; display: flex; align-items: center; justify-content: center; background: #0a0a0a; color: #fff; font-family: system-ui, sans-serif; padding: 20px;">
        <div style="max-width: 600px; text-align: center;">
          <h1 style="color: rgb(var(--color-error-rgb)); margin-bottom: 20px;">App Failed to Load</h1>
          ...
          <button onclick="localStorage.clear(); window.location.reload();" style="margin-top: 20px; padding: 12px 24px; background: rgb(var(--brand-primary-rgb)); color: white; borderRadius: 8px; cursor: pointer;">Clear Cache & Reload</button>
        </div>
      </div>
    `
  }
