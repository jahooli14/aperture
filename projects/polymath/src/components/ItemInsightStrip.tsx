    ...
    <div className="mt-6 space-y-2">
      ...
      {itemId && itemType && (
        <>
          ...
          >
            <Route className="h-3.5 w-3.5 text-brand-primary opacity-90 group-hover:opacity-100 transition-opacity" />
            <span className="text-xs font-medium text-brand-primary opacity-90 group-hover:opacity-100 transition-opacity">
