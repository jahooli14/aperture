...
export interface QueuedOperation {
  id?: number
  type: 'create_memory' | 'update_memory' | 'delete_memory' | 'create_project' | 'update_project' | 'delete_project' | 'create_list' | 'update_list' | 'delete_list' | 'add_list_item' | 'delete_list_item' | 'update_list_item' | 'reorder_list_items' | 'reorder_lists' | 'capture_media' | 'update_article' | 'delete_article'
  data: any
  timestamp: number
  retryCount: number
  lastError?: string
