 ...
 */
export async function normalizeTags(rawTags) {
    ...
    for (const rawTag of rawTags) {
        ...
        try {
            ...
            if (aliasMatch && aliasMatch.canonical_tags) {
                const canonicalTag = aliasMatch.canonical_tags.tag;
            ...
            if (similarTag && typeof similarTag === 'object' && 'tag' in similarTag) {
                ...
                const tag = similarTag.tag;
                const id = similarTag.id;
                const similarity = similarTag.similarity;
 ...
 */
async function inferCategory(tag) {
 ...
 */
export async function identifyTagMerges() {
