 ...
 */
async function extractMetadata(title, body) {
 ...
 */
async function storeEntities(memoryId, entities) {
    const allEntities = [];
 ...
 */
async function storeCapabilities(memoryId, skills, memoryTitle) {
 ...
 */
async function findAndCreateConnections(memoryId, userId, embedding, title, body) {
    try {
