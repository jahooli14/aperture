 ...
 *
 * When the user is offline we don't reload — a reload offline is guaranteed to
 * fail and produces a blank page or an infinite spinner. Throwing lets the
 * nearest ErrorBoundary render something useful instead.
 */
