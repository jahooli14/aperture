...
import frontierModes from '../../config/frontier-modes.json';
 ...
 */
export async function generateIdea(domainA, domainB, frontierMode, feedbackContext) {
 ...
 */
export async function scoreIdea(idea, existingIdeas) {
