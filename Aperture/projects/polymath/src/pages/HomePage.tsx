          ...
          <div className="space-y-3">
            {inspiration.url ? (
              <Link
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = 'rgba(40, 80, 130, 0.8)'
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.background = 'rgba(25, 50, 90, 0.6)'
                }}
              >
                <div className="space-y-2">
          ...
          <div className="p-6 rounded-xl backdrop-blur-xl" style={{
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                style={{
                  backgroundColor: 'rgba(40, 80, 130, 0.8)',
                  backdropFilter: 'blur(12px)',
                  WebkitBackdropFilter: 'blur(12px)',
                  boxShadow: '0 4px 16px rgba(0, 0, 0, 0.3)'
                }}
                onMouseEnter={(e) => e.currentTarget.style.backgroundColor = 'rgba(40, 80, 130, 0.9)'}
                onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'rgba(40, 80, 130, 0.8)'}
                title="Voice Note"
              >
